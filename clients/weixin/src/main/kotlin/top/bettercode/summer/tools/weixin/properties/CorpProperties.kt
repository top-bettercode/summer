...
open class CorpProperties : WeixinProperties("微信企业号") {
    override var basicAccessTokenUrl: String =
    ...
    companion object {
        val log: Logger = LoggerFactory.getLogger(CorpProperties::class.java)
