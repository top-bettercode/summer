    ...
    public void serialize(Object value, JsonGenerator gen, SerializerProvider provider)
        ...
        if (defaultValue == null) {
            ...
            if (jsonBigDecimal != null) {
                String divisor = jsonBigDecimal.divisor();
                new BigDecimalSerializer(jsonBigDecimal.scale(),("".equals(divisor) ? null : new BigDecimal(divisor)), jsonBigDecimal.roundingMode(),
