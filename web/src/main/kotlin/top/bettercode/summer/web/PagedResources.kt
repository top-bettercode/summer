...
class PagedResources<T>(number: Long, size: Long, totalPages: Long, totalElements: Long, content: T) {
    ...
    class PageMetadata(@JsonView(Any::class)
                       @JsonProperty var number: Long, @JsonView(Any::class)
                       @JsonProperty var size: Long, @JsonView(Any::class)
                       @JsonProperty var totalPages: Long, @JsonView(Any::class)
