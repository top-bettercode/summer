...
@SpringBootTest(properties = {
    "spring.autoconfigure.exclude="
        ...
        + "cn.bestwu.simpleframework.security.server.AuthorizationServerConfiguration,"
        + "cn.bestwu.simpleframework.security.server.SecurityServerConfiguration,"
        + "cn.bestwu.simpleframework.security.server.KeyStoreConfiguration,"
        + "cn.bestwu.config.WritableEnvironmentEndpointAutoConfiguration,"
        + "cn.bestwu.simpleframework.security.resource.SecurityResourceConfiguration,"
        + "cn.bestwu.simpleframework.config.CorsConfiguration,"
        + "cn.bestwu.logging.websocket.WebsocketConfiguration,"
        + "cn.bestwu.logging.ActuateLoggingConfiguration,"
