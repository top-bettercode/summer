 ...
 */
@Disabled
open class GurobiSolverTest {

    open val solver: Solver = GurobiSolver(logging = true, epsilon = 1e-5)
...
//        OptimalUtil.DEFAULT_EPSILON = 1e-6
                val numVar1 = numVar(0.0, 100.0)
                val numVar2 = numVar(0.0, 100.0)
                val onlyEnforceIf = numVar2.eqExpr(20.0).onlyEnforceIf(numVar1.eqExpr(10.0))
                numVar1.eq(10.0)
...
//        OptimalUtil.DEFAULT_EPSILON = 1e-6
                ...
                numVar1.eq(10.0)
                numVar2.neExpr(20.0).onlyEnforceIf(numVar1.eqExpr(10.0))
                arrayOf(numVar1, numVar2).maximize()
                solve()
                Assertions.assertTrue(isOptimal(), "result:" + getResultStatus())
                System.err.println(numVar1.value)
...
//        OptimalUtil.DEFAULT_EPSILON = 1e-9
                ...
                val numVar2 = numVar(0.0, 20.0)
                numVar1.eq(10.0)
                numVar2.ltExpr(20.0).onlyEnforceIf(numVar1.eqExpr(10.0))
                arrayOf(numVar1, numVar2).maximize()
                solve()
                Assertions.assertTrue(isOptimal(), "result:" + getResultStatus())
                System.err.println(numVar1.value)
