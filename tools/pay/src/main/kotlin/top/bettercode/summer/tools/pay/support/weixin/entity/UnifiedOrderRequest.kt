...
data class UnifiedOrderRequest(
        ...
        val timeExpire: String? = null,

        /**
         * 终端IP，支持IPV4和IPV6两种格式的IP地址。调用微信支付API的机器IP
         */
        @field:JsonProperty("spbill_create_ip")
        val spbillCreateIp: String = IPAddressUtil.inet4Address,
        ...
        val nonceStr: String = RandomUtil.nextString2(32),
