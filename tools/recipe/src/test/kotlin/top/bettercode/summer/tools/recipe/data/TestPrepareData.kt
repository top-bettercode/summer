    ...
    fun readRequirement(productName: String): RecipeRequirement {
        ...
        for (i in 0..9) {
            ...
            val indicator = when (i) {
                3 -> RecipeIndicator(index = 7, id = indicatorNames[7], name = indicatorNames[7], value = DoubleRange(min, max), type = RecipeIndicatorType.RATE_TO_OTHER, itId = "水溶磷", otherId = "磷")
                4 -> RecipeIndicator(index = 3, id = indicatorNames[3], name = indicatorNames[3], value = DoubleRange(min, max))
                5 -> RecipeIndicator(index = 4, id = indicatorNames[4], name = indicatorNames[4], value = DoubleRange(min, max))
                6 -> RecipeIndicator(index = 5, id = indicatorNames[5], name = indicatorNames[5], value = DoubleRange(min, max), type = RecipeIndicatorType.PRODUCT_WATER)
                7 -> RecipeIndicator(index = 6, id = indicatorNames[6], name = indicatorNames[6], value = DoubleRange(min, max), type = RecipeIndicatorType.WATER)
                8 -> RecipeIndicator(index = 10, id = indicatorNames[10], name = indicatorNames[10], value = DoubleRange(min, max))
                9 -> RecipeIndicator(index = 11, id = indicatorNames[11], name = indicatorNames[11], value = DoubleRange(min, max))
                else -> RecipeIndicator(index = i, id = indicatorNames[i], name = indicatorNames[i], value = DoubleRange(min, max))
            }
...
//        val relationIndexList = listOf(ReplacebleMaterialIDs(arrayOf(LIQUID_AMMONIA), MaterialIDs.of(AMMONIUM_CARBONATE), LA_2_CAUSE_RATIO),ReplacebleMaterialIDs(arrayOf(SULFURIC_ACID)))
    ...
    private fun readMaterials(materialPrices: Map<String, Double?>): List<RecipeMaterial> {
        ...
        for (materialForm in materialForms) {
            ...
            var i = 0
            indicators.add(RecipeIndicator(i, indicatorNames[i], indicatorNames[i], materialForm.totalNutrient.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.nitrogen!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.phosphorus!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.potassium!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.chlorine!!.scale()))
            i++
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.water!!.scale(), RecipeIndicatorType.WATER))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.waterSolublePhosphorusRate!!.scale(), RecipeIndicatorType.RATE_TO_OTHER, "水溶磷", "磷"))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.waterSolublePhosphorus!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.nitrateNitrogen!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.boron!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.zinc!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.manganese!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.copper!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.iron!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.molybdenum!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.magnesium!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.sulfur!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.calcium!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.organicMatter!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.humicAcid!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.fulvicAcid!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.activeBacteria!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.silicon!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index23!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index24!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index25!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index26!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index27!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index28!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index29!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index30!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index31!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index32!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index33!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index34!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index35!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index36!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index37!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index38!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index39!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index40!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index41!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index42!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index43!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index44!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index45!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index46!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index47!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index48!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index49!!.scale()))
            indicators.add(RecipeIndicator(++i, indicatorNames[i], indicatorNames[i], materialForm.index50!!.scale()))
