...
class MQueryDsl : MProjectGenerator() {
    ...
    override fun content() {
        clazz(queryDslType, true) {
            ...
            superClass =
                JavaType("top.bettercode.simpleframework.data.dsl.EntityPathWrapper").typeArgument(
                    type,
                    entityType
                )
            ...
            val basePathType =
                JavaType("top.bettercode.simpleframework.data.dsl.BasePath").typeArgument(
                    type,
                    entityType
                )
            columns.forEach {
                ...
                field(
                    it.javaName,
                    basePathType,
                    "new BasePath<>(this, \"${it.columnName}\")",
