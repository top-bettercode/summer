        ...
        if (!isFullComposite) {
            ...
            method("get${primaryKeyName.capitalized()}", primaryKeyType) {
                ...
                if (primaryKeyType == JavaType.stringInstance) {
                    annotation("@jakarta.validation.constraints.NotBlank${if (autoIncrement) "(groups = UpdateConstraint.class)" else ""}")
                } else {
                    annotation("@jakarta.validation.constraints.NotNull${if (autoIncrement) "(groups = UpdateConstraint.class)" else ""}")
                }
        ...
        method(
            ...
            if (!it.nullable) {
                ...
                if (it.javaType == JavaType.stringInstance) {
                    annotation("@jakarta.validation.constraints.NotBlank(groups = CreateConstraint.class)")
                } else {
                    annotation("@jakarta.validation.constraints.NotNull(groups = CreateConstraint.class)")
                }
            }
            +"return this.entity.get${
