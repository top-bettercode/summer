...
val entity: ProjectGenerator.(TopLevelClass) -> Unit = { unit ->
    unit.apply {
        ...
        annotation("@jakarta.persistence.Table(name = ${className}.TABLE_NAME)")
        annotation("@jakarta.persistence.EntityListeners(AuditingEntityListener.class)")
        ...
        field(primaryKeyName, primaryKeyType) {
            ...
            if (primaryKeys.size == 1) {
                ...
                if (primaryKey.autoIncrement) {
                    annotation("@jakarta.persistence.GeneratedValue(strategy = GenerationType.IDENTITY)")
                    ...
                    val generator = generatorStrategy.substringAfterLast(".")
                            ...
                            .capitalized()
                    annotation("@jakarta.persistence.GeneratedValue(strategy = GenerationType.AUTO, generator = \"$entityName$generator\")")
                    ...
                    annotation("@jakarta.persistence.GeneratedValue(strategy = GenerationType.SEQUENCE, generator = \"${entityName}Sequence\")")
                    annotation("@jakarta.persistence.SequenceGenerator(name = \"${entityName}Sequence\", sequenceName = \"${primaryKey.sequence}\", allocationSize = 1)")
                }
                ...
                annotation("@jakarta.persistence.EmbeddedId")
            }
        }
        //primaryKey getter
        method(
        ...
        otherColumns.forEach {
            ...
            field(it.javaName, it.javaType) {
                ...
                if (it.version) {
                    annotation("@jakarta.persistence.Version")
                }
                if (it.logicalDelete) {
