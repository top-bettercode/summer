...
open class BearychatAppender(private val properties: BearychatProperties, private val title: String) : AlarmAppender(properties.cyclicBufferSize, properties.sendDelaySeconds, properties.ignoredWarnLogger) {
    ...
    override fun sendMessage(timeStamp: Long, initialComment: String, message: List<String>): Boolean {
        return try {
            ...
            client.postMessage(properties.channel, title, initialComment, message)
        } catch (e: Exception) {
