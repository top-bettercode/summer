...
//    api(platform("org.springframework.cloud:spring-cloud-dependencies:2021.0.1"))
    ...
    constraints {
        ...
        api("com.oracle.database.jdbc:ucp:21.7.0.0")
        api("com.oracle.database.security:oraclepki:21.7.0.0")
        api("com.oracle.database.security:osdt_core:21.7.0.0")
        ...
        api("org.dhatim:fastexcel-reader:0.13.0")
        api("org.apache.poi:poi-ooxml:5.2.3")

        api("org.mybatis:mybatis:3.5.11")
        api("org.mybatis:mybatis-spring:2.0.7")
        api("org.mybatis.generator:mybatis-generator-core:1.4.1")

        api("com.querydsl:querydsl-apt:5.0.0:jpa")

        api("com.github.jsqlparser:jsqlparser:4.5")
        ...
        api("com.tencentcloudapi:tencentcloud-sdk-java:3.1.638")
        ...
        api("net.sourceforge.plantuml:plantuml:1.2022.12")
